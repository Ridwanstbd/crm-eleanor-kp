...
return [
    ...
    | oleh kelas validator. Beberapa aturan ini memiliki beberapa versi
    ...
    */
    ...
    'min' => [
        ...
        'numeric' => 'Bidang :attribute harus berukuran setidaknya :min.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Kata sandi yang diberikan di bidang :attribute telah muncul dalam kebocoran data. Silakan pilih kata sandi lain.',
    ],
    ...
    'prohibits'          => 'Bidang :attribute melarang :other ada.',
    ...
    'required_with_all'  => 'Bidang :attribute wajib diisi ketika semua :values ada.',
    ...
    | menggunakan konvensi "nama-atribut.aturan" untuk menamai baris.
    | Ini membuat Anda lebih cepat menentukan baris bahasa kustom tertentu
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris-baris bahasa berikut digunakan untuk mengganti placeholder atribut
    | kami dengan sesuatu yang lebih mudah dibaca, seperti "Alamat E-Mail"
    | daripada "email". Ini hanya membantu kami membuat pesan kami lebih ekspresif.
    |
    */
