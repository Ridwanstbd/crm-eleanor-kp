<x-Layouts.Modal 
    name="delete-message-template-{{ $template->id }}"
    title=""
    mode="default"
    maxWidth="sm"
    :showIcon="false">
    <form method="POST" action="{{ route('templates.destroy', $template) }}">
        ...
        <div class="flex justify-center">
            ...
            {{-- Pesan utama --}}
            <h2 class="text-lg font-bold text-gray-800">Yakin, Hapus Template?</h2>

            {{-- Tombol aksi --}}
            <div class="flex justify-center gap-4">
                <button type="button"
                    @click="$dispatch('close-modal', 'delete-message-template-{{ $template->id }}')"
